...
- `mis/kernel/DuneAnalyticsStreamerKernel.mis`
...
```bash
bin/misc mis/kernel/DuneAnalyticsStreamerKernel.mis --check --compact-letters
find mis -name '*.mis' -print0 | xargs -0 -n1 bin/misc --check --compact-letters
```

## Org

[clarity-fintech/dune-analytics-streamer](https://github.com/clarity-fintech/dune-analytics-streamer)
